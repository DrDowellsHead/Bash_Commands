...
#include <unistd.h>
#include "options.h"
#define BUFFER 32768 // Фиксированный размер буффера для минимизации системных вызовов

int main(int argc, int *argv[]) { // С помощью argc и argv читаю аргументы командной строки
